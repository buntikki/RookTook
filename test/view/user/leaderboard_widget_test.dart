...
import 'package:rooktook/src/view/user/leaderboard_screen.dart';
import 'package:rooktook/src/view/user/leaderboard_widget.dart';
  ...
  group('LeaderboardWidget', () {
    testWidgets('accessibility and basic info showing test', (WidgetTester tester) async {
      ...
      final app = await makeTestProviderScopeApp(
        tester,
        home: Column(children: [LeaderboardWidget(index: 0,)]),
