...
class AppLocalizationsKk extends AppLocalizations {
  ...
  String mobileGreeting(String param) {
    return 'Ассаламу алейкүм, $param';
  }

  @override
  String get mobileGreetingWithoutName => 'Ассаламу алейкүм';
  ...
  @override
  String get mobilePuzzleStormFilterNothingToShow => 'Сәйкестік жоқ, сүзгіні өзгертіп көріңіз';
  ...
  String get mobilePuzzleThemesSubtitle =>
      'Өз бастауларыңызға негізделген жұмбақтар, не кез-келген тақырып.';
  ...
  String get mobileSettingsImmersiveModeSubtitle =>
      'Ойын кезінде жүйенің элементтерін жасыру. Экран жиегіндегі жүйенің навигация қимыл белгілері сізге кедергі келтірсе - қолданарлық жағдай. Ойын мен Жұмбақ Дауылы кезінде жұмыс істейді.';
  ...
  @override
  String get mobileWaitingForOpponentToJoin => 'Қарсыластың қосылуын күтудеміз...';
  ...
  @override
  String get broadcastMyBroadcasts => 'Менің көрсетілімдерім';
  ...
  @override
  String get broadcastNewBroadcast => 'Жаңа тікелей көрсетілім';
  ...
  @override
  String get broadcastAddRound => 'Айналым қосу';

  @override
  String get broadcastOngoing => 'Болып жатқан';
  ...
  @override
  String get broadcastTournamentDescription => 'Жарыстың қысқа сипаттамасы';

  @override
  String get broadcastFullDescription => 'Оқиғаның толық сипаттамасы';

  @override
  String broadcastFullDescriptionHelp(String param1, String param2) {
    return 'Көрсетілімнің қосымша үлкен сипаттамасы. $param1 қолданысқа ашық. Ұзындығы $param2 таңбадан кем болуы керек.';
  }
  ...
  @override
  String get broadcastStartDateHelp => 'Міндетті емес, егер күнін біліп тұрсаңыз';

  @override
  String get broadcastCurrentGameUrl => 'Қазіргі ойын сілтемесі';

  @override
  String get broadcastDownloadAllRounds => 'Барлық айналымдарды жүктеп алу';

  @override
  String get broadcastResetRound => 'Бұл айналымды жаңарту';
  ...
  String get broadcastDeleteAllGamesOfThisRound =>
      'Айналымның бүкіл ойындарын жою. Оларды қайта құру үшін қайнар көзі белсенді болуы керек.';

  @override
  String get broadcastEditRoundStudy => 'Айналымның зертханасын өзгерту';
  ...
  String get broadcastDefinitivelyDeleteTournament =>
      'Жарысты айналым мен ойындарымен бірге толығымен жою.';
  ...
  @override
  String get broadcastFideProfile => 'FIDE төлқұжаты';
  ...
  String broadcastNbBroadcasts(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count көрсетілім',
      one: '$count көрсетілім',
    );
    return '$_temp0';
  }
  ...
  String get challengeDeclineTooFast =>
      'Бұл уақыт қалпы мен үшін тым шапшаң, одан баяу ойынға шақыруды жіберіңізші.';
  ...
  String get perfStatNotEnoughRatedGames =>
      'Тұрақты рейтингке ие болу үшін бағалы ойын саны жеткіліксіз.';
  ...
  String get preferencesPremovesPlayingDuringOpponentTurn =>
      'Алдын-ала жүру (қарсыластың кезегінде жүру)';
  ...
  String get puzzleYourPuzzleRatingWillNotChange =>
      'Сіздің жұмбақ шешу рейтингіңіз өзгермейді. Жұмбақтар жарыс емес екенін ескеріңіз. Мұндағы рейтингтің қызметі – сіздің деңгейіңізге сәйкес жұмбақты табуға көмекші болу.';

  @override
  String get puzzleFindTheBestMoveForWhite => 'Ақтың ең ұтымды жүрісін табыңыз.';

  @override
  String get puzzleFindTheBestMoveForBlack => 'Қараның ең ұтымды жүрісін табыңыз.';
  ...
  String get puzzleUseFindInPage =>
      'Браузер мәзірінде \"Осы бетте іздеуді\" қолдана қалаулы бастаманы тауып алыңыз!';
  ...
  String get puzzleStreakDescription =>
      'Қиындай беретін жұмбақтарды шешіп, жеңістер тізбегін құрыңыз. Уақытта шектеу жоқ. Бір бұрыс қадам болса, ойын бітті! Бірақ бір бәйгеде бір жүрісті өткізіп жібере аласыз.';
  ...
  String get puzzleStreakSkipExplanation =>
      'Тізбегіңіз үзілмес үшін бұл жүрісті өткізіп жіберіңіз. Әр бәйгеде бір рет қана жасауға болады.';
  ...
  String get puzzleFromMyGamesNone =>
      'Дерекқорыңызда жұмбақ жоқ (бірақ сізге деген құрметіміз одан азайған емес).\nЖүйрік әрі классикалық ойын ойнап, жұмбақ құрылуына себепші болыңыз!';
  ...
  String get puzzleImprovementAreasDescription =>
      'Жетістігіңізді жақсарту үшін осы жаттығуды көріңіз!';
  ...
  String get puzzleThemeArabianMateDescription =>
      'Ат пен тураның бірлесіп қарсылас патшаны тақта бұрышында ұстап алуы.';
  ...
  String get puzzleThemeAttackingF2F7Description =>
      '\"Қуырылған бүйрек\" бастауындағыдай f2 не f7 сарбазына бағытталған шабуыл.';
  ...
  String get puzzleThemeAttractionDescription =>
      'Қарсылас тасын белгілі бір шаршыға итермелейтін не күштеп ығыстыратын айырбастау не құрбан ету.';
  ...
  String get puzzleThemeBodenMateDescription =>
      'Қарсылас патшасының бір жағын өз тастары бөгеп тұрғанда, екі піл қиылыса шабуылдайды.';
  ...
  String get puzzleThemeCastlingDescription =>
      'Патшаны қорғаулы жерге кіргізіп, тураны шабуылға даярлаңыз.';
  ...
  String get puzzleThemeClearanceDescription =>
      'Тактиканы асыру мақсатында шаршыны, тік не диагоналды жолды босату үшін әдетте қарқынмен жасалынатын жүріс.';
  ...
  String get puzzleThemeDefensiveMoveDescription =>
      'Тастарды не артықшылықты жоғалтпау мақсатында жасалатын жүріс не жүрістер тізбегі.';
  ...
  String get puzzleThemeEnPassantDescription =>
      'Бір сазбаз, қасынан қарсыластың сарбазы өткенде, оны басып алатын жағдайды, яғни жолай басып алуды қамтитын тактика.';
  ...
  String get puzzleThemeExposedKingDescription =>
      'Қорғанысы нашар патша әдетте маттың иісін сезіп тұрады.';
  ...
  String get puzzleThemeHangingPieceDescription =>
      'Қорғанысы нашар не қорғаусыз тұрған қарсылас тасын басып алуды меңзейтін тактика.';
  ...
  String get puzzleThemeHookMateDescription =>
      'Қарсылас патшасына өз сарбазы бөгет бола тұра, ат, тура мен сарбаз арқылы қойылған мат.';
  ...
  String get puzzleThemeInterferenceDescription =>
      'Қарсыластың екі байланысқан тастарының арасына бөгет қойып, олардың біреуін не екеуін қорғаусыз ету. Мысалы, екі өзара қорғап тұрған туралардың арасына тұра қалған ат.';
  ...
  String get puzzleThemeIntermezzoDescription =>
      'Болжамға сай жүрудің орнына алдымен басқаша, қарсыласқа қауіп келтіретін, жауап беруге мәжбүрлейтін жүріс жасау. Басқаша \"Intermezzo\" не \"Zwischenzug\" деп те аталады.';
  ...
  String get puzzleThemeMasterVsMasterDescription =>
      'Екі атақты ойыншылардың ойындарынан алынған жұмбақтар.';
  ...
  String get puzzleThemePinDescription =>
      'Артта тұрған құнды тасты жоғалту қаупі болғандықтан, алдыңғы тас орнынан кете алмайтындай жағдай.';
  ...
  String get puzzleThemeQueenRookEndgameDescription =>
      'Уәзірлер, туралар мен сарбаздары ғана бар ойынсоңы.';
  ...
  String get puzzleThemeQueensideAttackDescription =>
      'Қарсылас патшасы уәзір жаққа бекінгеннен кейін оған жасалатын шабуыл.';
  ...
  String get puzzleThemeQuietMoveDescription =>
      'Шах етпейтін не басып алмайтын, бірақ болашақ соққыны дайындайтын жүріс.';
  ...
  String get puzzleThemeSacrificeDescription =>
      'Кейін бір артықшылыққа жету мақсатыменен тастан әдейі айырылу.';
  ...
  String get puzzleThemeSkewerDescription =>
      'Байлауға қарама-қарсы: құнды тас соққы астында бола, артындағы арзан тасты беріп, қашуға мәжбүр болатындай жағдай.';
  ...
  String get puzzleThemeSmotheredMateDescription =>
      'Өз тастарымен қамалған патша бірде-бір жүріс жасай алмайтын кезде оған қарсыластың аты жасаған мат.';
  ...
  String get puzzleThemeSuperGMDescription =>
      'Дүние жүзі мықтыларының ойындарынан алынған жұмбақтар.';
  ...
  String get puzzleThemeTrappedPieceDescription =>
      'Басып алынудан қаша алмайтын, жүрісі шектелген тас.';
  ...
  @override
  String get puzzleThemeMix => 'Аралас дастархан';
  ...
  String get settingsManagedAccountCannotBeClosed =>
      'Сіздің тіркелгіңіз біреудің басқаруында, сондықтан сіз оны жаба алмайсыз.';

  @override
  String get settingsCantOpenSimilarAccount =>
      'Кейін дәл сондай атпенен жаңа тіркелгі жасай алмайсыз (әріп үлкендігі басқаша болса да).';
  ...
  String get toInviteSomeoneToPlayGiveThisUrl =>
      'Ойынға біреуді шақыру үшін бұл сілтемені жіберіңіз';
  ...
  String get opponentLeftChoices =>
      'Қарсылас ойыннан шықты. Сіз жеңісті не теңдікті талап ете аласыз, немесе күтіңіз.';
  ...
  String get theFirstPersonToComeOnThisUrlWillPlayWithYou =>
      'Бұл сілтемеден бірінші келген адам сізбен ойнайды.';
  ...
  String get dtzWithRounding =>
      'Дөңгелектелген DTZ50\'\' келесі басып алғанша не сарбаз жүргенше дейін жартыжүрістердің санына негізделген';
  ...
  String get maybeIncludeMoreGamesFromThePreferencesMenu =>
      'Баптаулар мәзірінен тағы ойындар қосайық па?';
  ...
  String get unknownDueToRounding =>
      'Жеңіс не жеңілістің шарты: басып алудан не сарбаз жүрісінен кейін, Сизигия дерекқорында DTZ шамасын дөңгелектеу кезінде сізге ұсынылаған дерекқор тармағына еру.';
  ...
  String get computersAreNotAllowedToPlay =>
      'Компьютер көмегін пайдалану - тыйым. Ойын кезінде әр түрлі шахмат есептеуіштерін, дерекқорларын не басқа бір ойыншының көмегін қолданбаңыз. Сонымен қатар, бірнеше тіркелгі жасауды құптамаймыз, көп тіркелгі жасаушыға бұғау салынады.';
  ...
  String get changeUsernameNotSame =>
      'Тек әріптер үлкендігін өзгерту рұқсат. Мысалы, \"tolebi\" дегенді \"ToleBi\" деп.';
  ...
  String get signupUsernameHint =>
      'Тіркеулі атты таңдағанда, өз үйіңізде айтуға лайықты болатындай болсын. Оны кейін өзгерте алмайсыз. Орынсыз, ұятсыз сөздері болса, тіркелгіңіз толықтай жабылады!';
  ...
  String get blankedPassword =>
      'Бұл құпиясөзді сіз басқа сайтта қолданғансыз. Сол сайт құпиясөзді сақтай алмай жария етті. Сондықтан Личес тіркелгіңізді қорғау мақсатында сізден жаңа құпиясөзді орнатуды сұраймыз.';
  ...
  String get passwordSuggestion =>
      'Басқа біреу ұсынған құпиясөзді қолданбаңыз. Ол адам тіркелгіңізді ұрлауы мүмкін.';

  @override
  String get emailSuggestion =>
      'Басқа біреу ұсынған пошта мекенжайын қолданбаңыз. Ол адам тіркелгіңізді ұрлауы мүмкін.';
  ...
  String get usernameCanBeUsedForNewAccount =>
      'Осы атты жаңа тіркелгі жасау үшін қолдансаңыз болады';
  ...
  String get checkSpamFolder =>
      'Сонымен қатар, Спам қалтасында қарап көріңіз. Хат сонда болса, \"Спам емес\" деп белгілеу жөн болар.';

  @override
  String get emailForSignupHelp =>
      'Егер де осы амалдардың бәрі жарамаса, бізге осындай хат жіберіңіз:';
  ...
  String get noDrawBeforeSwissLimit =>
      'Швейцарлық жарыста 30 қадам болмай тепе-теңдік те болмайды.';
  ...
  String get siteDescription =>
      'Тегін онлайн шахмат алаңы. Кескіні таза сайтта шахмат ойнаңыз. Жарнама жоқ, тіркелу мен қосымша програмды қажет етпейді. Шахматты компьютермен, достарыңызбен не кез-келген қарсыласпен ойнаңыз.';
  ...
  String get inappropriateNameWarning =>
      'Кез-келген, тіпті шамалы орынсыз әрекет себебінен тіркелгіңіз жабылуы мүмкін.';
  ...
  @override
  String get profile => 'Төлқұжат';

  @override
  String get editProfile => 'Төлқұжатты өзгерту';
  ...
  String get bewareTheGameIsRatedButHasNoClock =>
      'Ескерту - ойын бағаланады, бірақ сағатсыз өтеді!';
  ...
  String get descPrivateHelp =>
      'Тек топ мүшелері көретін мәтін. Жазылған болса, жария сипаттаманы алмастырады.';
  ...
  String get allInformationIsPublicAndOptional =>
      'Бүкіл мәлімет – жалпыға ашық, әрі оны көрсету – сіздің өз еркіңіз.';

  @override
  String get biographyDescription =>
      'Өзіңіз туралы айтып беріңізші: айналысатын істеріңіз, неге шахматпен шұғылданасыз, ұнайтын бастаулар, ойыншылар, ...';
  ...
  String get aboutSimulRealLife =>
      'Бұл түсінік шынайы өмірден алынған: ойында бас ойыншы тақталарды аралап, бір-бірден жүріс жасап отырады.';
  ...
  String get keyRequestComputerAnalysis =>
      'Компьютерлік талдауды бастаңыз, Әр қателіктен сабақ алыңыз';
  ...
  String get tournamentHomeTitle =>
      'Шахмат жарыстары әр-түрлі уақыт қалыптары мен шахмат түрлерін қамтиды';

  @override
  String get tournamentHomeDescription =>
      'Қарқынды шахмат жарыстарына қош келдіңіз! Личестің ресми жарыстарына қатысам десеңіз не жаңадан жарысты құрастыру – таңдау сізде. Буллит, Блиц, Классикалық, Шахмат960, Тау патшасы, Үш шах пен басқа да қызықты шахмат түрлерін ойнаңыз.';
  ...
  String get tournamentMayHaveBeenCanceled =>
      'Егер ойыншылардың барлығы жарыстан шықса, бұл жарыс тоқталуы мүмкін.';
  ...
  String get weHaveSentYouAnEmailClickTheLink =>
      'Біз сізге электронды хат жібердік. Хаттағы сілтемеге бассаңыз, тіркелгіңіз расталады.';

  @override
  String get ifYouDoNotSeeTheEmailCheckOtherPlaces =>
      'Егер хат көрінбей тұрса, басқа болжамды жерлерді қарап көріңіз, мысалы – қоржын, спам, әлеуметтік желілер сияқты қалталар.';
  ...
  String get timeToProcessAMoveOnLichessServer =>
      'Личес сервердің жүрісті өңдеуге жұмсайтын уақыты';
  ...
  String get youCanAlsoScrollOverTheBoardToMoveInTheGame =>
      'Сонымен қатар, тақта үстінен тінтуір доңғалағын айналдырып жүріс жасай аласыз.';

  @override
  String get scrollOverComputerVariationsToPreviewThem =>
      'Компьютерлік тармақты көру үшін үстіне меңзер апарыңыз.';

  @override
  String get analysisShapesHowTo =>
      'Тақтада шеңбер мен нұсқағыш сызу үшін тінтуірмен оң шертіңіз немесе shift баса сол шертіңіз.';
  ...
  @override
  String get kidModeIsEnabled => 'Балалық нұсқа қосулы.';

  @override
  String get kidModeExplanation =>
      'Бұл сақтық үшін. Балалық нұсқада бүкіл әңгімелесу жолдары жабылған. Мақсатыңыз – бала мен мектеп оқушыларын басқа интернет қолданушыларынан қорғау болса, осы нұсқаны іске қосыңыз.';
  ...
  String get askYourChessTeacherAboutLiftingKidMode =>
      'Тіркелгіңізді ұстаз басқарады. Балалық нұсқаны өшіруді одан сұраңыз.';
  ...
  String get builtForTheLoveOfChessNotMoney =>
      'Ақша қуып емес, шахматты жақсы көргеннен жасап отырмыз';
  ...
  @override
  String get size => 'Үлкендігі';

  @override
  String get opacity => 'Айқындығы';
  ...
  @override
  String get boardReset => 'Бастапқы түстерді қайтару';
  ...
  String get usernameCharsInvalid =>
      'Тіркеулі атыңызда тек қана әріп, сан, сызықша мен төменгі сызықша сияқты таңбалар болу керек. Бірнеше сызықша не төменгі сызықшаларды қатарынан жазбаңыз.';
  ...
  String get playVariationToCreateConditionalPremoves =>
      'Шартты ертелі жүрістерді құру үшін бір тармақты ойнаңыз';
  ...
  String get agreementAssistance =>
      'Мен ойнап отырғанда, сырттан (басқа адамнан, компьютер, кітап не дерекқорды пайдалана) ешбір көмек алмаймын деп уәде беремін.';
  ...
  @override
  String get instructions => 'Нұсқаулық';

  @override
  String get showMeEverything => 'Бәрін көрсету';

  @override
  String get lichessPatronInfo =>
      'Личес – толығымен тегін/еркін, қайырымдылық негізінде жасалған програм.\nБүкіл жұмыс шығыны, әзірлеу, мазмұны пайдаланушылардың ақшалай демеуінен өтеледі.';

  @override
  String get nothingToSeeHere => 'Әзірге ештеңе жоқ.';
  ...
  String get stormYouPlayTheBlackPiecesInAllPuzzles =>
      'Барлық жұмбақтарда сіз қара түспен ойнайсыз';
  ...
  String get stormSkipExplanation =>
      'Өз тізбегіңізді сақтау үшін осы жүрістен бас тарту! Әр бәйгеде бір рет.';
  ...
  @override
  String get studyPrivate => 'Жеке';

  @override
  String get studyMyStudies => 'Менің зерттеулерім';

  @override
  String get studyStudiesIContributeTo => 'Қолдауымдағы зерттеулер';

  @override
  String get studyMyPublicStudies => 'Жалпыға ашық зерттеулерім';

  @override
  String get studyMyPrivateStudies => 'Жеке зерттеулерім';

  @override
  String get studyMyFavoriteStudies => 'Қалаулы зерттеулерім';

  @override
  String get studyWhatAreStudies => 'Зерттеулер деген не?';

  @override
  String get studyAllStudies => 'Бүкіл зерттеулер';

  @override
  String studyStudiesCreatedByX(String param) {
    return '$param жасаған зерттеулер';
  }

  @override
  String get studyNoneYet => 'Әзірге жоқ.';

  @override
  String get studyHot => 'Тренд';

  @override
  String get studyDateAddedNewest => 'Құрылған күні (жаңадан)';

  @override
  String get studyDateAddedOldest => 'Құрылған күні (ескіден)';

  @override
  String get studyRecentlyUpdated => 'Жақында құрылған';

  @override
  String get studyMostPopular => 'Ең танымалдары';
  ...
  @override
  String get studyAddMembers => 'Мүшелерді қосу';

  @override
  String get studyInviteToTheStudy => 'Зерттеуге шақыру';

  @override
  String get studyPleaseOnlyInvitePeopleYouKnow =>
      'Тек таныстарды әрі зерттеуге қосылуға шын ниетті адамдарды ғана шықырыңыз.';

  @override
  String get studySearchByUsername => 'Тіркеулі атымен іздеу';

  @override
  String get studySpectator => 'Көрермен';

  @override
  String get studyContributor => 'Қолдаушы';

  @override
  String get studyKick => 'Шығару';

  @override
  String get studyLeaveTheStudy => 'Зерттеуден шығу';

  @override
  String get studyYouAreNowAContributor => 'Сіз енді қолдаушысыз';

  @override
  String get studyYouAreNowASpectator => 'Сіз енді көрерменсіз';

  @override
  String get studyPgnTags => 'PGN тэгтері';
  ...
  @override
  String get studyCommentThisPosition => 'Осы тақта күйі туралы пікір қалдыру';

  @override
  String get studyCommentThisMove => 'Осы жүріс туралы пікір қалдыру';

  @override
  String get studyAnnotateWithGlyphs => 'Глифтермен түсіндірме жазуу';

  @override
  String get studyTheChapterIsTooShortToBeAnalysed => 'Бөлім талдауға жарамды болу үшін тым қысқа.';

  @override
  String get studyOnlyContributorsCanRequestAnalysis =>
      'Зерттеу қолдаушылары ғана компьютерлік талдауды сұрай алады.';

  @override
  String get studyGetAFullComputerAnalysis =>
      'Сервер-жақты компьютер осы негізгі жолға толық талдау жасайтын болады.';

  @override
  String get studyMakeSureTheChapterIsComplete =>
      'Талдауды бір рет қана сұрай аласыз, сондықтан бөлімді аяқтауды ұмытпаңыз.';

  @override
  String get studyAllSyncMembersRemainOnTheSamePosition =>
      'Барлық үйлескен мүшелер өз күйінде қалады';

  @override
  String get studyShareChanges =>
      'Көрермендермен өзгертулерді бөлісіңіз әрі серверде сақтап қойыңыз';

  @override
  String get studyPlaying => 'Қазір ойында';
  ...
  @override
  String get studyFirst => 'Бірінші';

  @override
  String get studyPrevious => 'Алдыңғы';

  @override
  String get studyNext => 'Келесі';

  @override
  String get studyLast => 'Соңғы';

  @override
  String get studyShareAndExport => 'Бөлісу мен Жүктеп алу';

  @override
  String get studyCloneStudy => 'Көшірме';
  ...
  @override
  String get studyStudyUrl => 'Зерттеудің сілтемесі';
  ...
  String studyStartAtX(String param) {
    return 'Басталуы: $param';
  }

  @override
  String get studyEmbedInYourWebsite => 'Сіздің сайт не блогыңызға арналған енгізу сілтемесі';

  @override
  String get studyReadMoreAboutEmbedding => 'Енгізу туралы оқыңыз';

  @override
  String get studyOnlyPublicStudiesCanBeEmbedded => 'Тек жалпыға ашық зерттеулер енгізуге жарамды!';

  @override
  String get studyOpen => 'Ашу';

  @override
  String studyXBroughtToYouByY(String param1, String param2) {
    return '$param1, оны сізге $param2 ұсынды';
  }

  @override
  String get studyStudyNotFound => 'Зерттеу табылмады';

  @override
  String get studyEditChapter => 'Бөлімді өңдеу';

  @override
  String get studyNewChapter => 'Жаңа бөлім';

  @override
  String studyImportFromChapterX(String param) {
    return '$param-нан жүктеп алу';
  }

  @override
  String get studyOrientation => 'Бағыты';

  @override
  String get studyAnalysisMode => 'Талдау нұсқасы';

  @override
  String get studyPinnedChapterComment => 'Қадаулы бөлім пікірі';

  @override
  String get studySaveChapter => 'Бөлімді сақтау';

  @override
  String get studyClearAnnotations => 'Түсіндірмені өшіру';

  @override
  String get studyClearVariations => 'Тармақты өшіру';

  @override
  String get studyDeleteChapter => 'Бөлімді жою';

  @override
  String get studyDeleteThisChapter => 'Бөлімді жоясыз ба? Кері жол жоқ!';

  @override
  String get studyClearAllCommentsInThisChapter =>
      'Бөлімдегі бүкіл пікір, глиф пен сызбаларды өшіресіз бе?';

  @override
  String get studyRightUnderTheBoard => 'Тура тақтаның астына';

  @override
  String get studyNoPinnedComment => 'Жоқ';

  @override
  String get studyNormalAnalysis => 'Қалыпты талдау';

  @override
  String get studyHideNextMoves => 'Келесі жүрістерді жасыру';

  @override
  String get studyInteractiveLesson => 'Интерактивті сабақ';

  @override
  String studyChapterX(String param) {
    return '$param-ші бөлім';
  }

  @override
  String get studyEmpty => 'Бос';

  @override
  String get studyStartFromInitialPosition => 'Басталуы: бастапқы күйден';

  @override
  String get studyEditor => 'Өңдеуші';

  @override
  String get studyStartFromCustomPosition => 'Басталуы: белгілі күйден';

  @override
  String get studyLoadAGameByUrl => 'Сілтеме арқылы ойындарды жүктеп салу';

  @override
  String get studyLoadAPositionFromFen => 'FEN арқылы ойындарды жүктеп салу';

  @override
  String get studyLoadAGameFromPgn => 'PGN арқылы ойындарды жүктеп салу';

  @override
  String get studyAutomatic => 'Автоматты түрде';
  ...
  @override
  String get studyCreateStudy => 'Зерттеуді құру';

  @override
  String get studyEditStudy => 'Зерттеуді өңдеу';

  @override
  String get studyVisibility => 'Көрінуі';

  @override
  String get studyPublic => 'Жалпыға ашық';

  @override
  String get studyUnlisted => 'Жасырын';

  @override
  String get studyInviteOnly => 'Шақырумен ғана';

  @override
  String get studyAllowCloning => 'Көшірмеге рұқсат беру';

  @override
  String get studyNobody => 'Ешкім';

  @override
  String get studyOnlyMe => 'Өзім ғана';

  @override
  String get studyContributors => 'Қолдаушылар';

  @override
  String get studyMembers => 'Мүшелер';

  @override
  String get studyEveryone => 'Барлығы';

  @override
  String get studyEnableSync => 'Үйлесуді қосу';

  @override
  String get studyYesKeepEveryoneOnTheSamePosition => 'Иә: бәрі бірдей күйде болады';

  @override
  String get studyNoLetPeopleBrowseFreely => 'Жоқ: бәріне еркін шолуға рұқсат ету';

  @override
  String get studyPinnedStudyComment => 'Қадаулы зерттеу пікірі';

  @override
  String get studyStart => 'Бастау';

  @override
  String get studySave => 'Сақтау';

  @override
  String get studyClearChat => 'Чатты өшіру';

  @override
  String get studyDeleteTheStudyChatHistory => 'Зерттеудің чат тарихын өшіресіз бе? Кері жол жоқ!';

  @override
  String get studyDeleteStudy => 'Зерттеуді жою';

  @override
  String studyConfirmDeleteStudy(String param) {
    return 'Бүкіл зерттеуді жоясыз ба? Қайтар жол жоқ. Растау үшін зерттеу атауын жазыңыз: $param';
  }

  @override
  String get studyWhereDoYouWantToStudyThat => 'Бұл күйдің зерттеуін қай жерде бастайсыз?';

  @override
  String get studyGoodMove => 'Жақсы жүріс';

  @override
  String get studyMistake => 'Қате';

  @override
  String get studyBrilliantMove => 'Әдемі жүріс';

  @override
  String get studyBlunder => 'Өрескел қателік';

  @override
  String get studyInterestingMove => 'Қызық жүріс';

  @override
  String get studyDubiousMove => 'Күмәнді жүріс';

  @override
  String get studyOnlyMove => 'Жалғыз жүріс';

  @override
  String get studyZugzwang => 'Цугцванг';

  @override
  String get studyEqualPosition => 'Күйлері шамалас';

  @override
  String get studyUnclearPosition => 'Күйі анық емес';

  @override
  String get studyWhiteIsSlightlyBetter => 'Ақ сәл күштірек';

  @override
  String get studyBlackIsSlightlyBetter => 'Қара сәл күштірек';

  @override
  String get studyWhiteIsBetter => 'Ақтың жағдайы жақсы';

  @override
  String get studyBlackIsBetter => 'Қараның жағдайы жақсы';

  @override
  String get studyWhiteIsWinning => 'Ақ жеңеді';

  @override
  String get studyBlackIsWinning => 'Қара жеңеді';

  @override
  String get studyNovelty => 'Жаңашылдық';

  @override
  String get studyDevelopment => 'Дамыту';

  @override
  String get studyInitiative => 'Белсенді';

  @override
  String get studyAttack => 'Шабуыл';

  @override
  String get studyCounterplay => 'Қарсы шабуыл';

  @override
  String get studyTimeTrouble => 'Уақыт қаупі';

  @override
  String get studyWithCompensation => 'Өтеумен';

  @override
  String get studyWithTheIdea => 'Бір оймен';

  @override
  String get studyNextChapter => 'Келесі бөлім';

  @override
  String get studyPrevChapter => 'Алдыңғы бөлім';

  @override
  String get studyStudyActions => 'Зерттеу әрекеттері';

  @override
  String get studyTopics => 'Тақырыптар';

  @override
  String get studyMyTopics => 'Менің тақырыптарым';

  @override
  String get studyPopularTopics => 'Белгілі тақырыптар';

  @override
  String get studyManageTopics => 'Тақырыптарды басқару';

  @override
  String get studyBack => 'Кері қайту';

  @override
  String get studyPlayAgain => 'Қайта ойнау';

  @override
  String get studyWhatWouldYouPlay => 'Осы күйде не ойнамақсыз?';
  ...
  @override
  String get timeagoRightNow => 'дәл қазір';

  @override
  String get timeagoCompleted => 'аяқталған';
  ...
  String timeagoInNbWeeks(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count аптадан кейін',
      one: '$count аптадан кейін',
    );
    return '$_temp0';
  }
  ...
  String timeagoInNbMonths(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count айдан кейін',
      one: '$count айдан кейін',
    );
    return '$_temp0';
  }
  ...
  String timeagoInNbYears(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count жылдан кейін',
      one: '$count жылдан кейін',
    );
    return '$_temp0';
  }
  ...
  String timeagoNbWeeksAgo(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count апта бұрын',
      one: '$count апта бұрын',
    );
    return '$_temp0';
  }
  ...
  String timeagoNbMinutesRemaining(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count минут қалды',
      one: '$count минут қалды',
    );
    return '$_temp0';
  }
  ...
  String timeagoNbHoursRemaining(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count сағат қалды',
      one: '$count сағат қалды',
    );
    return '$_temp0';
  }
}
